public class Teste1 {
	...
	public static void main(String[] args) {
		try {
			CaixaEletronico c1 = new CaixaEletronico("12345", "123.456.789-10");
			c1.creditar(300);
			c1.debitar(100);
			c1.creditar(200);
			...
			CaixaEletronico c2 = new CaixaEletronico("78910", "00000000000");
			...
			CaixaEletronico c3 = new CaixaEletronico("66666", "019.876.543-21");
